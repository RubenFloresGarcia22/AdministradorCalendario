...
public class ServicioModificarEvento extends ServicioBase{
  
  private final String VISTA_LOGIN="/Vistas/Usuarios/Login.jsp";
  private final String VISTA_MODIFICAR_EVENTO="/Vistas/Eventos/ModificarEvento.jsp";
  private final String VISTA_LISTADO_EVENTOS="/Vistas/Calendarios/Calendario.jsp";
  ...
  public void doPost(HttpServletRequest peticion, HttpServletResponse respuesta)throws ServletException, IOException{
    this.establecerEncabezado(respuesta);
    if(peticion.getParameter("btnModificar") != null){
      ...
      this.enviarA(VISTA_MODIFICAR_EVENTO,peticion,respuesta);
    }else{
      if(peticion.getParameter("btnFinalizarModificacion")!= null){
        Evento evento = new Evento();
        evento.setId(Integer.parseInt(peticion.getParameter("hdnIdEvento")));
        ...
        direccion.setId(Integer.parseInt(peticion.getParameter("hdnIdDireccion")));
        direccion.setNombreCalle(peticion.getParameter("txtNombreCalle"));
        direccion.setCodigoPostal(Integer.parseInt(peticion.getParameter("txtCodigoPostal")));
        ...
        System.out.println("Tamanio de arreglo: "+informacionParticipantes.length);
        ...
        ConectorEventos conectorEventos = new ConectorEventos();
        try{
          conectorEventos.actualizar(evento);
          peticion.setAttribute("lblEventoModificado","Evento Modificado");
          peticion.setAttribute("idEventoModificado", evento);
          this.enviarA(VISTA_LISTADO_EVENTOS, peticion, respuesta);
        }catch(Exception e){
          System.err.println(e.getMessage());
          e.printStackTrace();
          throw (ServletException)e;
